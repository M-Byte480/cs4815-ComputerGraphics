...
osg::Geode* createPyramid()
{
   ...
   colors->push_back(osg::Vec4(0.01f, 1.0f, 1.0f, 1.0f) ); //vertex with cyan
   colors->push_back(osg::Vec4(0.95f, 1.0f, 0.17f, 1.0f) ); //vertex with yellow
   colors->push_back(osg::Vec4(1.0f, 0.25f, 0.99f, 1.0f) ); //vertext bright purple
   colors->push_back(osg::Vec4(1.0f, 1.0f, 1.0f, 1.0f) ); // vertext with white
   colors->push_back(osg::Vec4(0.68f, 0.0f, 1.0f, 1.0f )); // vertex with purple
   ...
   colorIndexArray->push_back(5); // vertex 4 assigned color array element 0
   ...
   //(*texcoords)[0].set(0.00f,0.0f); // tex coord for vertex 0 original vertexes
   //(*texcoords)[1].set(0.25f,0.0f); // tex coord for vertex 1 
   //(*texcoords)[2].set(0.50f,0.0f); //  ""
   //(*texcoords)[3].set(0.75f,0.0f); //  "";

	// I flipped the order of setting:
